    ...
    return (
        <section className="bg-white">
            <div className="section-container">
                <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_20rem] xl:grid-cols-[minmax(0,1fr)_22rem] xl:gap-12">
                            ...
                            <div>
                                ...
                                <ul className="mt-8 grid gap-4 sm:grid-cols-3">
                                    {localized.results.map((result) => (
                                        ...
                                        >
                                            <p className="text-2xl font-bold leading-none text-primary sm:text-[28px]">
                                                {result.value}
                                            </p>
                                            <p className="mt-2 text-xs leading-snug text-primary/65 sm:text-sm">
                                                {result.label}
                                            </p>
                                        </li>
                                    ))}
