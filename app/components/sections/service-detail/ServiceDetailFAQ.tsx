...
import type { ServiceFaq } from "@/app/lib/services";
...
function LeafToggle({ open }: { open: boolean }) {
    return (
        <span
            className={cn(
                "flex size-8 shrink-0 items-center justify-center rounded-full transition",
                open ? "bg-white/15 text-white" : "bg-secondary/15 text-secondary",
            )}
        >
            <svg
                viewBox="0 0 14 21"
                    ...
                    return (
                        <li key={faq.question}>
                            <button
                                ...
                                className={cn(
                                    "w-full cursor-pointer rounded-2xl border px-5 py-4 text-left transition sm:px-6",
                                    isOpen
                                        ? "border-primary bg-primary text-white"
                                        : "border-primary/10 bg-white text-primary hover:border-secondary/40",
                                )}
                            >
                                ...
                                >
                                    <div className="overflow-hidden">
                                        <p
                                            className={cn(
                                                "mt-3 border-t border-dashed pt-3 text-sm leading-relaxed",
                                                isOpen
