...
import { pricingPackages } from "@/app/lib/services";
...
export default function ServicesPricing() {
    return (
        ...
        >
            <div
                aria-hidden
                className="pointer-events-none absolute -left-16 top-10 size-56 opacity-[0.06] sm:size-72"
            >
                <Image
            ...
            <div
                aria-hidden
                className="pointer-events-none absolute -right-12 bottom-10 size-48 opacity-[0.06] sm:size-64"
            >
                <Image
                    src="/icons/singleLeaf.svg"
                    alt=""
                ...
                <header className="mx-auto max-w-3xl text-center">
                    <p className="flex items-center justify-center gap-2">
                        <svg
                            ...
                            fill="none"
                            aria-hidden
                            className="h-5 w-3.5 shrink-0 text-secondary"
                        >
                            <path
                    ...
                    >
                        Simple, Clear, and Customized for You
                    </h2>

                    <p className="mt-5 text-sm leading-relaxed text-primary/65 sm:text-base">
                        Clear, flexible packages designed to fit every garden and
                        budget. Choose what works for you — we&apos;ll handle the rest.
                    </p>
                </header>
                ...
                <ul className="mt-12 grid gap-6 lg:mt-14 lg:grid-cols-3 lg:gap-7">
                    {pricingPackages.map((pkg) => (
                        <li key={pkg.name}>
                            <article
                                className={cn(
                                    "flex h-full flex-col overflow-hidden rounded-[1.75rem] border bg-white shadow-[0_16px_48px_rgba(10,37,14,0.08)]",
                                    pkg.featured
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p className="mt-4 flex items-end justify-center gap-1">
                                        ...
                                        <span className="mb-1.5 text-sm opacity-80">
                                            {pkg.period}
                                        </span>
                                    </p>
                                    ...
                                    <Button
                                        variant={
                                            pkg.featured ? "primary" : "secondary"
                                        }
                                        className={cn(
                                            "mt-6 w-full rounded-lg px-6 py-3 text-sm sm:text-base",
                                            pkg.featured &&
