            ...
            <div className="section-container">
                <div className="grid items-stretch gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:gap-14 xl:gap-16">
                    <div className="relative mx-auto h-full min-h-[22rem] w-full sm:min-h-[24rem] lg:mx-0">
                        ...
                        <div className="absolute -top-4 right-0 z-10 w-[9.5rem] rounded-tl-[1.75rem] rounded-br-[1.75rem] bg-primary px-5 py-7 text-center text-white shadow-lg sm:-top-6 sm:right-2 sm:w-[10.5rem] sm:px-6 sm:py-8 lg:-right-4">
                            <Image
                                src="/icons/leaf.svg"
                                alt=""
                                width={41}
